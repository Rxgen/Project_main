    ...
    <div className="small-card">
      <div className="small-card__content">
        <div className="small-card__links">
          <Link href={normalizedPdfUrl} className="small-card__link" target="_blank" rel="noopener noreferrer">
            {title}
        ...
        <div className="small-card__download">
          <a
            ...
            className="small-card__download-link"
            target='_blank'
          // onClick={(e) => {
          //   e.preventDefault();
          //   if (pdfUrl && pdfUrl !== '#') {
          ...
          <a
            href={normalizedPdfUrl || '#'}
            className="small-card__download-button"
            target="_blank"
            download
          // onClick={(e) => {
          //   e.preventDefault();
